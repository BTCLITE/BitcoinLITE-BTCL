...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x000007f58d1882eb2d35dca69a159b8ca7d72334c841408558e750c28fa6c047");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BITCOINLite: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
 ...
 static const int64 nTargetTimespan = 25200;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000007f58d1882eb2d35dca69a159b8ca7d72334c841408558e750c28fa6c047");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1426593062;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2611878;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BITCOINLiteCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BITCOINLiteMiner started\n");
    ...
    try { loop {
        ...
        printf("Running BITCOINLiteMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BITCOINLiteMiner terminated\n");
        throw;
    }
}
